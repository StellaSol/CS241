 ...
 *
 *  Input: None
 *  Output: Checking... (no more output means success)
 *
 *  Visible data fields:
 *  NONE
 *
 ...
 *   Remarks
 *   -------
 *   All non coding answers are in BST Driver
 *************************************************************************/
...
public class BinarySearchTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    public void iterativeInsert(AnyType x)
    {
    	root=iterativeInsert(x, root);
    }
    ...
    public boolean iterativeContains(AnyType x) {
    	return iterativeContains(x,root);
    }
    ...
    private BinaryNode<AnyType> iterativeInsert( AnyType x, BinaryNode<AnyType> t )
    {
    	BinaryNode<AnyType> curr=t;
        ...
        int compareResult2 = x.compareTo( parent.element );
    ...
    private boolean iterativeContains( AnyType x, BinaryNode<AnyType> t )
    {
